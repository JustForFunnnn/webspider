...
# from webspider.tasks.job import update_job_data
# from common.exception import RequestsError
# from webspider.controllers.company import CompanyController
# from webspider.controllers.company_industry import CompanyIndustryController
# from webspider.controllers.industry import IndustryController
...
def crawl_lagou_companies_pagination(city_id=0, finance_stage_id=0, industry_id=0):
    ...
    headers = utils.http_tools.generate_http_request_headers()

    response_json = requests.get(url=url, params=prams, headers=headers, allow_redirects=False,
