...
from webspider.controllers.job import JobController
from webspider.controllers.city import CityController
from webspider.controllers.keyword import KeywordController
from webspider.controllers.job_keyword import JobKeywordController
from webspider.utils.time_tools import job_date2timestamp
...
from webspider.utils.http_tools import generate_http_header, filter_http_tag
...
def generate_job_data(job, company_id):
    ...
    nature = JOB_NATURE_DICT[job['jobNature']]
