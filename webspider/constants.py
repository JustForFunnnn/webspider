...
CRAWLED_COMPANY_JOBS_REDIS_KEY = 'crawled_company_jobs_{lg_company_id}'
...
"""
    HTTP 相关 (基于减少 lg 的网站负载考虑, 屏蔽以下常量的实际内容)
"""
HTTP_HEADER = {}
...
"""
    相关网页 (基于减少 lg 的网站负载考虑, 屏蔽以下常量的实际内容)
"""
