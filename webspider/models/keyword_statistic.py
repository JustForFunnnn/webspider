...
class KeywordStatisticModel(BaseModel):
    ...
    city_jobs_count = Column(VARCHAR(2048), nullable=False, doc=u'城市职位数量统计')
    ...
    @property
    def per_day_jobs_count(self):
        return JobsCountModel.list(filter_by={'keyword_id': self.keyword_id}, order_by=JobsCountModel.date.asc())
